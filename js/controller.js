addEventListener("DOMContentLoaded", function (d) {
  ...
  var elements = Omega.elements,
    ...
    $startup = Omega.utilities.toElement(
      '<div class="conversation-piece fuchsia startup intro" style="opacity: 1;">' +
  ...
  $input.addEventListener("keypress", function (e) {
    ...
    var value, response, self, fuchsia;
